...
const SECTOR_CORR: Record<string, number> = {
  ...
  'fixed_income|fixed_income': 1,
  'fixed_income|finance': 0.45,
  'fixed_income|utilities': 0.35,
  'fixed_income|tech': 0.1,
  'fixed_income|consumer': 0.15,
  'fixed_income|energy': 0.2,
  'fixed_income|health': 0.15,
  'fixed_income|industrial': 0.2,
  'fixed_income|materials': 0.15,
  'fixed_income|commodities': 0.1,
  'fixed_income|index': 0.3,
  'fixed_income|real_estate': 0.35,
  'commodities|commodities': 1,
  'commodities|energy': 0.55,
  'commodities|materials': 0.5,
  'commodities|tech': 0.15,
  'commodities|finance': 0.2,
  'commodities|industrial': 0.4,
  'commodities|index': 0.35,
  'commodities|real_estate': 0.2,
  'index|index': 1,
  'index|tech': 0.5,
  'index|finance': 0.55,
  'index|consumer': 0.45,
  'index|industrial': 0.45,
  'index|real_estate': 0.4,
  'real_estate|real_estate': 1,
  'real_estate|finance': 0.4,
  'real_estate|utilities': 0.3,
};
